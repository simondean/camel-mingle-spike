...
public class AtomFeedProcessor extends BaseAtomProcessor {
  ...
  public AtomFeedProcessor(String projectName, Element feed, Repository repository) {
    super(feed.getNamespace());
    this.feed = feed;
    entryProcessor = new AtomEntryProcessor(projectName, getAtomNamespace(), repository);
  }
